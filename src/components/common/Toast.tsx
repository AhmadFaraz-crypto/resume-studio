  ...
  return (
    <div
      className={classnames(
        'fixed top-4 right-4 z-50 max-w-sm w-full bg-white rounded-lg shadow-lg border transform transition-all duration-300 ease-in-out',
        getToastStyles(),
        {
    ...
    >
      <div className="p-4">
        <div className="flex items-start">
          <div className={classnames('flex-shrink-0 mr-3', getIconStyles())}>
            {getIcon()}
          </div>
